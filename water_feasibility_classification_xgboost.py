...
Original file is located at
    https://colab.research.google.com/drive/1GHtYPAZ8srT2InyGxfzvBc5ICBo7ebLf
"""
...
train_df = pd.read_csv('/content/drive/MyDrive/DSC/train.csv')
test_df = pd.read_csv('/content/drive/MyDrive/DSC/test.csv')
...
# pd.DataFrame(preds).to_csv('/content/drive/MyDrive/DSC/xgboost.csv')
...
submission = pd.read_csv('/content/drive/MyDrive/DSC/sample_submission.csv')
submission
